    ...
    <section className="panel">
      <div className="align-elements panel__container">
        ...
        <form className="panel__form" action="" onSubmit={handleSubmit}>
          ...
          <input required type="text" name="overview" placeholder="overview" />
          ...
          <label htmlFor="ingredients">Ketadigan mahsulotlar ro'yhati !</label>
          <textarea
            name="ingredients"
            aria-multiline={true}
            placeholder="ingredients"
          />
          <label htmlFor="instructions">Ko'rsatmalarni kiriting !</label>
          <textarea rows={7} name="instructions" placeholder="instructions" />
